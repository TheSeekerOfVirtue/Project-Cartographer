///<summary>
/// Script by Keijiro Takahashi, and slightly editted by The Seeker Of Virtue
/// source:
/// https://github.com/keijiro/RippleEffect
/// Ripple effect for camera
///</summary>
...
public class RippleEffect : MonoBehaviour {
    ...
    class Droplet {
        ...
        public void Update (float speedMult) {
            time += Numbers.DeltaTime() * speedMult;
        }
    ...
    void Update () {
        ...
        */
        ...
        foreach (var d in droplets) d.Update (speedMult);
